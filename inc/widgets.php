...
if ( ! function_exists( 'understrap_widgets_init' ) ) {
	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'hinit' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'hinit' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'hinit' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'hinit' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'hinit' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'hinit' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'hinit' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'hinit' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'hinit' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'hinit' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'hinit' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'hinit' ),
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s dynamic-classes">',
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Logo Area', 'hinit' ),
				'id'            => 'footerlogo_sidebar',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'hinit' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Menu Area', 'hinit' ),
				'id'            => 'footermenu_sidebar',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'hinit' ),
		...
		*/
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Main', 'hinit' ),
				'id'            => 'footermain',
				'description'   => __( 'Footer main widget', 'hinit' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Side', 'hinit' ),
				'id'            => 'footerside',
				'description'   => __( 'Footer side widget', 'hinit' ),
				'before_widget' => '<div id="%1$s" class="footer-widget %2$s ">',
				'after_widget'  => '</div><!-- .footer-widget -->',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',

...
function custom_breadcrumbs() {
        ...
        $home_title=__('Homepage','understrap' );
        ...
        // Build the breadcrums
            ...
            if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
                ...
                if($post_type != 'post') {
                    ...
                    echo '<li class="item-cat item-custom-post-type-'.$post_type.' kuller=is-here"><a class="bread-cat bread-custom-post-type-' . $post_type . '" href="' . $post_type_archive . '" title="' . $post_type_object->labels->name . '">' . $post_type_object->labels->name . '</a></li>';
                    echo '<li class="separator"> '.$separator.' </li>';
                }

	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'hinit' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'hinit' ); ?></th>
			</tr>
		</thead>
		<tbody>
